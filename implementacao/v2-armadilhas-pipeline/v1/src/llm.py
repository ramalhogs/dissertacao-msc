"""Cliente LLM da mini-versão 1, com registro de raciocínio quando disponível.

O cliente aceita `reasoning_effort`, captura tokens de raciocínio e preserva
integralmente o texto bruto devolvido pelo provedor.
...
# ---------------------------------------------------------------------------
# Extração de código para inspeção; não há julgamento automático na v1.
# ---------------------------------------------------------------------------
